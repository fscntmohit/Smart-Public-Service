...
export const getMyComplaints = (config) => api.get('/complaints/my', config);
export const getOfficerComplaints = (params) => api.get('/complaints/officer', { params });
export const getAllComplaints = (params, config = {}) => api.get('/complaints', { ...config, params });
...
export const getBreachedComplaints = (config) => api.get('/complaints/breached', config);
