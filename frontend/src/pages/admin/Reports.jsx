  ...
  return (
    <div className="slide-up space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Download system-wide complaint analytics in PDF format.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card p-5">
          <p className="text-xs uppercase tracking-wide text-slate-500">Scope</p>
          <p className="text-lg font-semibold text-slate-800 mt-1">All Complaints</p>
        </div>
        <div className="card p-5">
